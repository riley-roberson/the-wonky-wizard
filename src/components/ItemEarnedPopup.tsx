...
export default function ItemEarnedPopup({ item, skill }: ItemEarnedPopupProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30">
      <div className="animate-pop-in mx-4 max-w-md rounded-3xl bg-white p-8 text-center shadow-2xl">
        ...
        <p className="mb-2 text-xl font-bold text-gray-800">{earned!.name}</p>
        <p className="text-base text-gray-600">{earned!.description}</p>
        <button
